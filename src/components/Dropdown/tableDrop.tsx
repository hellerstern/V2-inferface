  ...
  return (
    <>
      ...
      <StyledMenu
        ...
        onClose={handleClose}
      >
        <MenuItem onClick={handleMenuClicked} sx={{fontSize: '12px'}}>Before closing fees</MenuItem>
        <MenuItem onClick={handleMenuClicked} sx={{fontSize: '12px'}}>After closing fees</MenuItem>
      </StyledMenu>
    </>
  );
};
