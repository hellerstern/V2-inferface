...
export const TigrisDateRangePicker = ({
  popperPlacement
}: {
  ...
  const CustomInput = forwardRef((props: PickerProps, ref) => {
    ...
    return <CustomTextField inputRef={ref} label={props.label != null || ''} {...props} value={value} disabled />;
  });
...
const DatePickerWrapper = styled(Box)<BoxProps>(({ theme }) => ({
  ...
  '& .react-datepicker': {
    ...
    '& .react-datepicker__day--in-range, & .react-datepicker__day--in-selecting-range': {
      ...
      backgroundColor: `#8F989F !important`
    },
    ...
    '& .react-datepicker__day--selected, & .react-datepicker__month--selected, & .react-datepicker__year-text--selected, & .react-datepicker__quarter--selected':
      {
        ...
        backgroundColor: `#B2B2B2 !important`,
        '&:hover': {
          backgroundColor: `#262620 !important`
        }
      },
