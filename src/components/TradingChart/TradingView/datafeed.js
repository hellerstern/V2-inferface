...
export default {
  ...
  getBars: async (symbolInfo, resolution, periodParams, onHistoryCallback, onErrorCallback) => {
    ...
    try {
      ...
      const data = await (await fetch(`https://js-chart-history-b4lol.ondigitalocean.app/history?symbol=${symbolInfo.ticker}&from=${from}&to=${to}&resolution=${resolution}`)).json();
